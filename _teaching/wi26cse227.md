...
- *Presenter*: Instructor, [slides](https://docs.google.com/presentation/d/1mBjV6SqBJGvMIKCtfMFO9359HrWMw5Dr6C_QTxi3AgA/edit?usp=sharing), [follow-up](https://docs.google.com/document/d/10DoeGqKja5W9zeZrUJdfeteDMbJpaeVPeNM6wB9xwuQ/edit?usp=sharing)
...
- *Additional reading*:
  ...
  - [Low-Level Software Security by Example](https://web.archive.org/web/20160609191027id_/https://courses.cs.washington.edu/courses/cse484/14au/reading/low-level-security-by-example.pdf) — U. Erlingsson et al.
- *Presenter*: Students (see canvas), [slides](https://docs.google.com/presentation/d/16Wb404OeC6gM_uYnii_DrLBGYFinvpgRQGcwANJdRPo/edit?usp=sharing)

**Tue Jan 20 2026**: Design Principles  
- *Reading*:
  - [Preventing Privilege Escalation](https://www.usenix.org/legacy/event/sec03/tech/full_papers/provos_et_al/provos_et_al_html/) — N. Provos et al.
  - [Design Principles (Skim Only)](https://cseweb.ucsd.edu/~efernandes/teaching/res/saltzer.pdf) - Saltzer & Shroefer
- *Additional reading*:
  - [Principles and Implementation Techniques of Software-Based Fault Isolation](https://cseweb.ucsd.edu/~dstefan/cse227-spring21/papers/tan:sfi.pdf) — G. Tan  
- *Presenter*: Students (see canvas), [slides](https://docs.google.com/presentation/d/1DXDUUfuCnk7hx7kRbPtgFIl54qzRQ0X_JjgTC0nwzQ0/edit?usp=drive_link)

**Thu Jan 22 2026**: Usable Security 
- *Reading*:
  - [An empirical study of cryptographic misuse in android applications](https://dl.acm.org/doi/abs/10.1145/2508859.2516693) - Egele et al
- *Additional reading*:
- *Presenter*: Students (see canvas), [slides](https://docs.google.com/presentation/d/1TtiNFn7aCaJLHNvIMy2Uuv8bP6eSf0U9IADvj-oikVk/edit?usp=drive_link)

**Tue Jan 27 2026**: OS security  
- *Reading*:
  - [seL4: Formal Verification of an OS Kernel](https://dl.acm.org/doi/abs/10.1145/1629575.1629596) — G. Klein et al.
- *Presenter*: Name, [slides](https://docs.google.com/presentation/d/1HKNWgVFjYRJ2SIhtbr2SuLnJfROyHrDCOQf7zAwynzg/edit?usp=drive_link)
...
- *Presenter*: Students (see canvas), [slides](https://docs.google.com/presentation/d/18w7fFK8JgACtpuDv6dGWIQ0_cFVFUb1XqIcZJP9g0dM/edit?usp=drive_link)
...
- *Presenter*: Name, [slides](https://docs.google.com/presentation/d/1dvWTbyTiBh8k-bjU7W5UueomOHDtOa_Ja9h_mPdt65Y/edit?usp=sharing)
...
- *Presenter*: Name, [slides](https://docs.google.com/presentation/d/1b0IekyJd5lYHA46rhytdr7Qv62V8-D56tPohImDJGxs/edit?usp=drive_link)
...
- *Presenter*: Name, [slides](https://docs.google.com/presentation/d/1P20Kw_b7lV5klQRF2GKT2fu4AFnIqY6Yi9zFJiYtJGM/edit?usp=drive_link)
...
- *Presenter*: Students (see canvas), [slides](https://docs.google.com/presentation/d/1ho2mXjbuU42mxF3YRXBhwQ19L5OXvKCPXWRF6NrJza4/edit?usp=sharing)
...
- *Reading (Not required for this day)*:
  - [Protecting the 4G and 5G Cellular Paging Protocols against Security and Privacy Attacks](https://petsymposium.org/popets/2020/popets-2020-0008.pdf) — A. et al
  - [A11y Attacks: Exploiting Accessibility in Operating Systems](https://dl.acm.org/doi/abs/10.1145/2660267.2660295) — Y. Jang
  - [Communication Efficient Differentially Private Federated Learning Using Second Order Information](https://petsymposium.org/popets/2025/popets-2025-0032.php) - M. Krouka
- *Presenter*: Instructor (see canvas), 

**Thu Feb 19 2026**: Hardware security (Virtual)
- *Reading*:
  - [Efficiently Mitigating Transient Execution Attacks using the Unmapped Speculation Contract](https://www.usenix.org/system/files/osdi20-behrens.pdf) — J. Behrens et al.
- *Presenter*: Students (see canvas), [slides](https://docs.google.com/presentation/d/1FmI4wFg2bI0bO6s1DEZv9Kj1viAhx7QVseNe2_sXVLo/edit?usp=drive_link)

**Fri Feb 20 2026**: Status update  (Project Plan Update)

**Tue Feb 24 2026**: LLM attacks  
- *Reading*:
  - [Extracting Training Data from Large Language Models](https://www.usenix.org/system/files/sec21-carlini-extracting.pdf) -N. Carlini et al
- *Presenter*: Students (see canvas), [slides](https://docs.google.com/presentation/d/1rFHcbCLpU7fjLml7_TztZI3Q0X-_oaMnndazgobp354/edit?usp=drive_link)
...
- *Presenter*: Students (see canvas), [slides](https://docs.google.com/presentation/d/1Ifc9kH-xgS42hyU53Ae-FFmwpx_dvg-29DpxhXkEzT4/edit?usp=drive_link)
...
- *Reading*:
  - [A Survey on Model Extraction Attacks and Defenses for Large Language Models](https://dl.acm.org/doi/abs/10.1145/3711896.3736573) -K. Zhao
...
evaluation of the paper when you are the presenter and when you are not. Click [here](https://docs.google.com/presentation/d/1fn3pfsgoOSBtywlBUBCMnfB19UOkG92yoTntCZF9rcs/edit?usp=sharing) for a slide template you can use.
