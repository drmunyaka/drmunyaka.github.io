...
- *Reading*:
  - [Reflections on Trusting Trust](papers/thompson:reflections.pdf) — K. Thompson  
- *Additional reading*:
  - [How to Read a Paper](papers/keshav:how.pdf) — S. Keshav  

**Thu Jan 8 2026**: Low-level vulnerabilities and defenses  
- *Reading*:
  - [Hacking Blind](papers/bittau:brop.pdf) — A. Bittau et al.

**Tue Jan 13 2026**: Low-level vulnerabilities and defenses  
- *Reading*:
  - [AEG: Automatic Exploit Generation](papers/avgerinos:aeg.pdf) — T. Avgerinos et al.  
- *Additional reading*:
